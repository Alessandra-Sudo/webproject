        ...
        <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg lg:max-w-4xl">
            ...
            <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <form action="/signin" method="post">
                    ...
                    <div class="mt-4">
                        <label class="block mb-2 text-sm font-medium text-gray-600" for="LoggingEmailAddress">Email
                            Address</label>
                        <input id="LoggingEmailAddress" name="email" value="{{ old('email') }}"
                    ...
                    <div class="mt-4">
                        <div class="flex justify-between">
                            ...
                            <a href="#" class="text-xs text-gray-500 hover:underline">Forget
                                Password?</a>
                        </div>

                        <input id="loggingPassword" name="password" value="{{ old('password') }}"
                            class="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg focus:outline-none focus:ring focus:ring-lime-300 focus:ring-opacity-50"
                            type="password" />
                    </div>
                    ...
                    <div class="mt-6">
                        <button type="submit"
                            class="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-lime-700 rounded-lg hover:bg-lime-800 focus:outline-none focus:ring focus:ring-lime-300 focus:ring-opacity-50">
                            Sign In
                        </button>
                    </div>
                </form>
                ...
                <div class="flex items-center justify-between mt-4">
                    ...
                    <a href="/signup" class="text-xs text-gray-500 uppercase hover:underline">or sign
                        up</a>
                    <span class="w-1/5 border-b md:w-1/4"></span>
                </div>
            </div>
